...
To see the query paths generated by the driver you can use it in debug mode by passing :debug_mode => true as
the third argument of the Factual constructor. Here is an example in irb:


````ruby
> factual = Factual.new(key, secret, :debug_mode => true)
